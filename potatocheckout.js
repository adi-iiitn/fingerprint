...
let totalPrice = 0;
let finalPrice = 0; // Total price after discount and delivery charges
...
function placeOrder() {
  ...
  const prefilledUrl = `${googleFormUrl}&entry.167652935=${encodeURIComponent(name)}&entry.711003979=${encodeURIComponent(mobile)}&entry.1445439165=${encodeURIComponent(address)}&entry.1159606041=${encodeURIComponent(cartItems)}&entry.996163308=${encodeURIComponent(finalPrice.toFixed(2))}`;
